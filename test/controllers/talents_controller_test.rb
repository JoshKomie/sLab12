...
class TalentsControllerTest < ActionController::TestCase
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post :create, talent: { Description: @talent.Description, First: @talent.First, Last: @talent.Last, done: @talent.done }
    end
  ...
  test "should update talent" do
    patch :update, id: @talent, talent: { Description: @talent.Description, First: @talent.First, Last: @talent.Last, done: @talent.done }
    assert_redirected_to talent_path(assigns(:talent))
  end
